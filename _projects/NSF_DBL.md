...
One of the benefits of Bayesian learning is to enable **out-of-distribution detection**. The figure below shows that Bayesian LeNETs learned in a decentralized fashion based on MNIST data respond differently to the SVHN dataset (out-of-distribution) 
